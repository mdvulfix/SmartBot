...
def get_logger(name: str) -> logging.Logger:
    ...
    # Для Windows используем корректную кодировку
    ...
    file_handler = RotatingFileHandler(
        ...
        backupCount=3,
        encoding='utf-8'  # Явно указываем кодировку для файлов
    )
...
class PositionManager:
    ...
    def open_position(
        ...
        position_id = f"pos-{self.position_counter}-{datetime.datetime.utcnow().strftime('%Y%m%d')}"

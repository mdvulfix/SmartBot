...
class OKXExchange:
    ...
    def _request(self, method, endpoint, body=None, params=None):
        ...
        headers, body_str = self._sign(method, endpoint, body)
    ...
    def place_futures_limit_order(self, symbol, side, price, size, td_mode='cross', pos_side='net', cl_ord_id=''):
        ...
        body = {"instId": symbol, "tdMode": td_mode, "side": side, "ordType": "limit", "px": str(price), "sz": str(size)}
...
if __name__ == "__main__":
    ...
    order_result = exchange.place_futures_limit_order(symbol="BTC-USDT-SWAP",side="buy",price=55000,size=1)
